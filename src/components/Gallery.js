                                        ...
                                        <div className='revealCard'>
                                            <div className='revealCard-inner'>
                                                ...
                                                <div classNane='revealCard-back'>
                                                    <img src={'public/images/card-handlebars.png'} width="250" alt="Haircut" />
                                                </div>
                                            </div>
                                        </div>
                                    </Col>
                                    ...
                                    <Col sm={12} md={6} lg={3}>
                                        <div className='revealCard'>
                                            <div className='revealCard-inner'>
                                                ...
                                                <div classNane='revealCard-back'>
                                                    <img src={'public/images/card-lampshade.png'} width="250" alt="Haircut" />
                                                </div>
                                            </div>
                                        </div>
                                    </Col>
                                    ...
                                    <Col sm={12} md={6} lg={3}>
                                        <div className='revealCard'>
                                            <div className='revealCard-inner'>
                                                ...
                                                <div classNane='revealCard-back'>
                                                    <img src={'public/images/card-pencil.png'} width="250" alt="Haircut" />
                                                </div>
                                            </div>
                                        </div>
                                    </Col>
                                    ...
                                    <Col sm={12} md={6} lg={3}>
                                        <div className='revealCard'>
                                            <div className='revealCard-inner'>
                                                ...
                                                <div classNane='revealCard-back'>
                                                    <img src={'public/images/card-chevron.png'} width="250" alt="Haircut" />
                                                </div>
                                            </div>
                                        </div>
                                    </Col>
                                    ...
                                    <Col sm={12} md={6} lg={3}>
                                        <div className='revealCard'>
                                            <div className='revealCard-inner'>
                                                ...
                                                <div classNane='revealCard-back'>
                                                    <img src={'public/images/card-walrus.png'} width="250" alt="Haircut" />
                                                </div>
                                            </div>
                                        </div>
                                    </Col>
                                    ...
                                    <Col sm={12} md={6} lg={3}>
                                        <div className='revealCard'>
                                            <div className='revealCard-inner'>
                                                ...
                                                <div classNane='revealCard-back'>
                                                    <img src={'public/images/card-horseshoe.png'} width="250" alt="Haircut" />
                                                </div>
                                            </div>
                                        </div>
                                    </Col>
                                    ...
                                    <Col sm={12} md={6} lg={3}>
                                        <div className='revealCard'>
                                            <div className='revealCard-inner'>
                                                ...
                                                <div classNane='revealCard-back'>
                                                    <img src={'public/images/card-imperial.png'} width="250" alt="Haircut" />
                                                </div>
                                            </div>
                                        </div>
                                    </Col>
                                    ...
                                    <Col sm={12} md={6} lg={3}>
                                        <div className='revealCard'>
                                            <div className='revealCard-inner'>
                                                ...
                                                <div classNane='revealCard-back'>
                                                    <img src={'public/images/card-fuManchu.png'} width="250" alt="Haircut" />
                                                </div>
                                            </div>
                                        </div>
                                    </Col>
